			...
			var U = function () {
				...
				Z = function (t, e) {
					...
					e.currentScript &&
						...
						(i = e.currentScript.getAttribute(
			...
			return (function t() {
						...
						(Wt && Wt === t) ||
							...
							($t =
								"ADD_URI_SAFE_ATTR" in t
									? M(E(Bt), t.ADD_URI_SAFE_ATTR)
									: Bt),
							(Ht =
								"ADD_DATA_URI_TAGS" in t
									? M(E(Ft), t.ADD_DATA_URI_TAGS)
									: Ft),
							(wt =
								"FORBID_TAGS" in t ? M({}, t.FORBID_TAGS) : {}),
							(xt =
								"FORBID_ATTR" in t ? M({}, t.FORBID_ATTR) : {}),
							...
							Pt &&
								...
								!0 === Pt.svgFilters &&
									(M(gt, D), M(yt, N), M(yt, O)),
								!0 === Pt.mathMl &&
									(M(gt, A), M(yt, I), M(yt, O))),
							t.ADD_TAGS &&
								(gt === vt && (gt = E(gt)), M(gt, t.ADD_TAGS)),
							t.ADD_ATTR &&
								(yt === bt && (yt = E(yt)), M(yt, t.ADD_ATTR)),
					...
					Vt = function (t) {
						...
						if ((o && M(wt, ["title"]), !e || !e.documentElement)) {
							...
							a.parentNode.removeChild(
								a.parentNode.firstElementChild
							),
								(a.outerHTML = r);
						}
				...
				i.isSupported &&
					(function () {
						try {
							...
							b(/<\/title/, t.querySelector("title").innerHTML) &&
								(o = !0);
						} catch (t) {}
					})();
				...
				var Jt = function (t) {
					...
					ne = function t(e) {
						...
						for (
							Qt("beforeSanitizeShadowDOM", e, null);
							(i = n.nextNode());

						)
							Qt("uponSanitizeShadowNode", i, null),
								te(i) ||
									(i.content instanceof l && t(i.content),
									ie(i));
				...
				return (
					(i.sanitize = function (t, n) {
						...
						if (
							...
							(1 ===
								(o = (r =
									Vt("\x3c!--\x3e")).ownerDocument.importNode(
									t,
									!0
								)).nodeType &&
								"BODY" === o.nodeName) ||
						...
						for (var u = Jt(Rt ? t : r); (s = u.nextNode()); )
							(3 === s.nodeType && s === h) ||
								te(s) ||
								(s.content instanceof l && ne(s.content),
								ie(s),
								(h = s));
				...
				var $t = {
					...
					Kt = (function () {
						try {
							...
							return (
								t || (Xt && Xt.binding && Xt.binding("util"))
							);
						} catch (t) {}
					})(),
				...
				var Ye = (function t(e) {
					var i,
						n = (e =
							null == e
								? Gt
								: Ye.defaults(Gt.Object(), e, Ye.pick(Gt, Pt)))
							.Array,
						r = e.Date,
						dt = e.Error,
						ft = e.Function,
						...
						Ve =
							e.clearTimeout !== Gt.clearTimeout &&
							e.clearTimeout,
					...
					function Gi(t, e) {
						for (
							var i = -1, r = e.length, a = n(r), o = null == t;
							++i < r;
					...
					function Vi(t, e, i, n, r, a) {
						var o,
							...
							h = 2 & e,
							d = 4 & e;
						if ((i && (o = r ? i(t, n, r, a) : i(t)), void 0 !== o))
							return o;
						if (!Bo(t)) return t;
						var x = No(t);
					...
					(Li.templateSettings = {
						...
						(Ci.prototype.get = function (t) {
							...
							if (mi) {
								var i = e[t];
								return "__lodash_hash_undefined__" === i
									? void 0
									: i;
							}
					...
					function jn(t, e) {
						var i = t.length;
						if (i)
							return oa((e += e < 0 ? i : 0), i) ? t[e] : void 0;
					}
					...
					function rr(t, e, i) {
						for (
							var n = -1, r = t.length, a = e.length, o = {};
							++n < r;
					...
					function xr(t) {
						return function (e, i, n) {
							for (
								var r = -1, a = _t(e), o = n(e), s = o.length;
								s--;
					...
					function Lr(t) {
						return Wr(function (e) {
							...
							return function () {
								var t = arguments,
									n = t[0];
								if (s && 1 == t.length && No(n))
									return s.plant(n).value();

								for (
									var r = 0, a = i ? e[r].apply(this, t) : n;
									++r < i;
					...
					function Sr(t, e, i, r, a, o, s, l, h, c) {
						...
						return function g() {
							for (
								var v = arguments.length, y = n(v), b = v;
								b--;
					...
					function Or(t, e, i, n, r, a, o, s, l, h) {
						...
						var u = [
							...
							d = i.apply(void 0, u);
						return (
							ha(t) && va(d, u), (d.placeholder = n), wa(d, t, e)
						);
					}
					...
					function qr(t, e, i, r, s, l, h, c) {
						...
						if (
							...
							var g = (function (t, e, i) {
								...
								return function e() {
									var a =
										this && this !== Gt && this instanceof e
											? r
											: t;
					...
					function Hr(t, e, i, n) {
						return void 0 === t || (Do(t, wt[i]) && !Tt.call(n, i))
							? e
							: t;
					}
					...
					function Vr(t) {
						return (Tt.call(Li, "placeholder") ? Li : t)
							.placeholder;
					}
					...
					function ra(t) {
						return "function" != typeof t.constructor || ua(t)
							? {}
							: Si(Ut(t));
					}
					...
					function ha(t) {
						var e = Yr(t),
							i = Li[e];
						if ("function" != typeof i || !(e in ji.prototype))
							return !1;
						if (t === i) return !0;
						var n = Gr(i);
						return !!n && t === n[0];
					...
					function ma(t, e) {
						for (
							var i = t.length, n = oi(e.length, i), r = gr(t);
							n--;
					...
					var Ya = Pn(function (t, e) {
						...
						Ja = Pn(function (t) {
							var e = Pa(t);
							return (
								zo(e) && (e = void 0), nr(ce(t, zo), Jr(e, 2))
							);
						}),
						Xa = Pn(function (t) {
							var e = Pa(t);
					...
					var Qa = Pn(function (t) {
						...
						return (
							(i =
								"function" == typeof i ? (t.pop(), i) : void 0),
							Ga(t, i)
						);
					});
					...
					return (
						...
						(Li.escape = function (t) {
							return (t = ss(t)) && q.test(t)
								? t.replace(R, Re)
								: t;
						}),
						(Li.escapeRegExp = function (t) {
							return (t = ss(t)) && G.test(t)
								? t.replace(Z, "\\$&")
								: t;
						}),
						(Li.every = function (t, e, i) {
							var n = No(t) ? he : en;
							return (
								i && sa(t, e, i) && (e = void 0), n(t, Jr(e, 3))
							);
						}),
						(Li.find = ro),
						(Li.findIndex = ja),
						...
						ln(ji.prototype, function (t, e) {
							var i = /^(?:filter|find|map|reject)|While$/.test(
									e
								),
								n = /^(?:head|last)$/.test(e),
								r =
	...
	function (t, e, i) {
		...
		function O(t) {
			I.forEach((e) => {
				try {
					...
					console &&
						console.log &&
						console.log("Error handling trace", t);
				}
			});
		}
		...
		lt.extend = function (t) {
			...
			return (
				...
				t.options &&
					n.options &&
					(t.options = N({}, n.options, t.options)),
				N(n, t),
				(e.extend = lt.extend),
		...
		class ht {
			...
			removeEventListener(t, e, i) {
				...
				for (
					var n = 0, r = this._tl_events, a = r[t].length;
					n < a;
					n++
				)
		...
		const ut = (function () {
			...
			function w(t) {
				...
				i >= 0 &&
					((e = y.slice(i + 1)), (y.length = i), (y = y.concat(e)));
			}
			...
			function x(t, e) {
				...
				return (
					(i = t.match(c)) &&
						(n.rotate = j(i[1], e ? e.rotate : null)),
				...
				return (
					...
					"translatex" in t &&
						(e +=
							...
							"px) "),
					"skewx" in t &&
						(e += "skew(" + t.skewx + "deg," + t.skewy + "deg)"),
					e
				);
			}
			...
			function D(t, e) {
				...
				for (n = 1; n < r; ++n)
					for (i = 0; i < r - n; ++i)
						(a[i][0] =
							(1 - e) * a[i][0] + e * a[parseInt(i + 1, 10)][0]),
							(a[i][1] =
								(1 - e) * a[i][1] +
								e * a[parseInt(i + 1, 10)][1]);
		...
		class ft {
				...
				w
					...
					this.options.enable.x &&
						(this._el.move.style.left =
							this.data.pagex.start -
							this._el.move.offsetWidth / 2 +
							"px"),
					this.options.enable.y &&
						(this._el.move.style.top =
							this.data.pagey.start -
							this._el.move.offsetHeight / 2 +
							"px"),
						...
						? t.originalEvent
							? ((this.data.pagex.end =
							  ...
							  (this.data.pagey.end =
									t.originalEvent.touches[0].screenY))
							: ((this.data.pagex.end =
									t.targetTouches[0].screenX),
							  (this.data.pagey.end =
									t.targetTouches[0].screenY))
			...
			_animateMomentum() {
				...
				this.options.enable.y &&
					((this.options.constraint.top ||
						this.options.constraint.bottom) &&
			...
			mt = (function () {
				...
				return (
					...
					(M.init = function (t, i) {
						...
						if ("string" == typeof t) {
							...
							if (S(t))
								...
								(n = M.fragment(t.trim(), RegExp.$1, i)),
									(t = null);
							else {
								if (void 0 !== i) return e(i).find(t);
								n = M.qsa(l, t);
					...
					(e.fn = {
						...
						next: function (t) {
							return e(this.pluck("nextElementSibling")).filter(
								t || "*"
							);
						},
						html: function (t) {
						...
						attr: function (e, i) {
							...
							return "string" == typeof e && void 0 === i
								? 0 == this.length || 1 !== this[0].nodeType
									? void 0
									: "value" == e &&
									  "INPUT" == this[0].nodeName
									? this.val()
									: !(n = this[0].getAttribute(e)) &&
									  e in this[0]
									? this[0][e]
									: n
						...
						data: function (t, e) {
							var i = this.attr(
								"data-" + t.replace(m, "-$1").toLowerCase(),
								e
							);
						...
						css: function (i, r) {
							if (arguments.length < 2) {
								...
								if ("string" == typeof i)
									return (
										a.style[n(i)] || o.getPropertyValue(i)
									);
						...
						position: function () {
							if (this.length) {
								...
								return (
									(n.top -=
										parseFloat(e(t).css("margin-top")) ||
										0),
									(n.left -=
										parseFloat(e(t).css("margin-left")) ||
										0),
									(r.top +=
										parseFloat(
											e(i[0]).css("border-top-width")
										) || 0),
									(r.left +=
										parseFloat(
											e(i[0]).css("border-left-width")
										) || 0),
									{
										top: n.top - r.top,
										left: n.left - r.left,
			...
			(function (t) {
				...
				(t.fn.delegate = function (t, e, i) {
					...
					(t.fn.live = function (e, i) {
						return (
							t(document.body).delegate(this.selector, e, i), this
						);
					}),
					(t.fn.die = function (e, i) {
						return (
							t(document.body).undelegate(this.selector, e, i),
							this
						);
					}),
							...
							(function (e) {
								e.processData &&
									...
									!e.data ||
										...
										((e.url = _(e.url, e.data)),
										(e.data = void 0));
							})(r),
							!1 === r.cache &&
								(r.url = _(r.url, "_=" + Date.now()));
						var f = r.dataType,
							m = /\?.+=\?/.test(r.url);
						if ("jsonp" == f || m)
							return (
		...
		const Tt = {
			...
			Mt = lt.extend({
				...
				_getDateData: function () {
					...
					return (
						t.month > 0 && t.month <= 12 && (t.month = t.month - 1),
						t
					);
				},
					...
					t
						...
						e
							...
							: this.data.format_short ||
							  (this.data.format_short = this.findBestFormat(
									!0
							  ));
				},
			});
		...
		class jt {
			...
			formatDate(t, e) {
				return t.constructor == Date
					...
					: (O("Unfamiliar date presented for formatting"),
					  t.toString());
			}
			...
			formatJSDate(t, e) {
				var i = this,
					n = function (t, e) {
						...
						if (n) t = e < 12 ? n[0] : n[1];
						return (
							"<span class='tl-timeaxis-timesuffix'>" +
							t +
							"</span>"
						);
					};
				...
				var a = t.getDate(),
					...
					p = {
						...
						yy: String(l).slice(2),
						yyyy:
							l < 0 && this.has_negative_year_modifier()
								? Math.abs(l)
								: l,
						h: h % 12 || 12,
						hh: z(h % 12 || 12),
			...
			en: {
				...
				dateformats: {
					...
					full_long_small_date:
						"h:MM TT' <small>mmm d',' yyyy'</small>'",
				},
				bigdateformats: {
					fallback: [
		...
		class Vt {
			...
			addEvent(t, e) {
				...
				return void 0 === t.start_date
					? (O("Missing start date, skipping event"),
					  console.log(t),
					  null)
			...
			addEra(t) {
				...
				if (void 0 === t.start_date)
					throw new D("missing_start_date_err", e);
				this._processDates(t),
					this._tidyFields(t),
					this.eras.push({
		...
		class se {
			constructor(t, e) {
				...
				(this._scale = t.scale),
					...
					(this._pixel_width =
						this._screen_multiplier * this._display_width),
					...
					(this._scaled_padding =
						(1 / this.getPixelsPerTick()) *
						(this._display_width / 2)),
			...
			getPixelsPerTick() {
				return this._axis_helper.getPixelsPerTick(
					this._pixels_per_milli
				);
			}
			...
			_computePositionInfo(t, e, i) {
				...
				if (n.length) {
					...
					for (a = 0; a < this._positions.length; a++) {
						((o = this._positions[a]).group = n.indexOf(
							t[a].group || ""
						)),
							(o.row = 0);

						for (
							var h = (d = l[o.group]).positions.length - 1;
							h >= 0;
							h--
						)
					...
					for (var c = n.length; ; ) {
						...
						for (c = 0, a = 0; a < l.length; a++) {
							...
							if ((d = l[a]).n_overlaps && u) {
								var f = this._computeRowInfo(
									d.positions,
									d.n_rows + 1
								);

								(d.n_rows = f.n_rows),
									(d.n_overlaps = f.n_overlaps),
									u--;
							}
		...
		class le {
			...
			setRowPosition(t, e) {
				(this.options.height = e * this.data.rows),
					...
					(this._el.container.style.height =
			...
			_positionTickArray(t, e, i) {
				if (t[1] && t[0]) {
					...
					for (var r = 1, a = 0; a < t.length; a++) {
						var o = t[a];
						(o.tick.style.left =
							e.getPosition(o.date.getMillisecond()) + "px"),
		...
		class de {
				...
				this._state.loaded &&
					...
					((this._el.content_item.style.maxHeight = c
						...
						: this.options.height -
						  ...
						  30 +
						  "px"),
					(this._el.container.style.maxWidth =
			...
			_updateDisplay(t, e, i) {
				t && (this.options.width = t),
					...
					this._el.caption &&
						(this.options.caption_height =
							this._el.caption.offsetHeight + 5),
		...
		let me = new (class {
			...
			load(t, e, i, n, r) {
				...
				if (
					!this.pending[t] &&
					(l = this.pending[t] = this.queue[t].shift())
				) {
		...
		class ge extends de {
			...
			_updateMediaDisplay() {
				(this._el.content_item.style.height =
					...
					(this._el.content_item.style.width =
						this.options.width + "px");
			}
				...
				if (this.youtube_loaded)
					try {
						this.player.getPlayerState() ==
							YT.PlayerState.PLAYING && this.player.pauseVideo();
					} catch (t) {
						O(t);
					}
			}
				...
				return (function (t) {
					function r(e, r) {
						if ("z" == e.slice(-1)) r.zoom = e;
							...
							((r = {}).location = o),
								(streetview_params = e.split(","));

							for (let t in n.streetview) {
								var s = parseInt(t) + 1;
								"pitch" == n.streetview[t] &&
								"90t" == streetview_params[s]
									? (r[n.streetview[t]] = 0)
									: (r[n.streetview[t]] = streetview_params[
											s
									  ].slice(0, -1));
							}
						}
		...
		class ye extends de {
			constructor(t, e, i) {
				super(t, e, i),
					(this.blockquote = Wt.a.sanitize(this.data.url));
			}
		...
		class Te extends de {
			_loadMedia() {
				...
				(this._el.content_item = this.domCreate(
					...
					(t =
						"https://vine.co/v/" + this.media_id + "/embed/simple"),
					(this._el.content_item.innerHTML =
		...
		class Me extends de {
			_loadMedia() {
				...
				if (
					...
					if (!(i && i.length > 2))
						return void e.loadErrorDisplay(
							e._("twitterembed_invalidurl_err")
						);
					this.media_id = i[2];
				}
				(t =
		...
		class Ce extends de {
			...
			createMedia() {
				...
				try {
					...
					console.log(`Instagram: error fetching ${t}`),
						console.log(e);
				}
			}
		...
		class Re extends de {
			_loadMedia() {
				try {
					...
					if (
						...
						(this.media_id = e[2]),
							(this.data.url =
								"http://imgur.com/gallery/" + this.media_id);
					} else
						this.data.url &&
							(this.media_id = this.data.url
								.split("/")
			...
			createMedia() {
				var t = this,
					e =
						"https://api.imgur.com/oembed.json?url=" +
						this.data.url;
				(this._el.content_item = this.domCreate(
					"div",
					...
					vt({
						...
						error: function (e, i, n) {
							"parsererror" == i
								? t.loadErrorDisplay(
										t._("imgur_invalidurl_err")
								  )
								: t.loadErrorDisplay(
										t._("unknown_read_err", i)
								  );
						},
					}),
					this.onLoaded();
		...
		class We {
			...
			_momentum() {
				...
				(this.data.direction = null),
					...
					i.x &&
						(Math.abs(e.x) > this._el.drag.offsetWidth / 2 &&
							(n = !0),
						Math.abs(e.x) > 1e4 &&
							((this.data.direction = "left"),
							e.x > 0 && (this.data.direction = "right"))),
					i.y &&
						(Math.abs(e.y) > this._el.drag.offsetHeight / 2 &&
							(n = !0),
						Math.abs(e.y) > 1e4 &&
							((this.data.direction = "up"),
							e.y > 0 && (this.data.direction = "down"))),
		...
		class Ue {
			...
			_getTimeScale() {
				...
				return (
					0 == t &&
						(O("marker_height_min option must not be zero."),
						(t = 30)),
			...
			setZoomFactor(t) {
				t <= this.options.zoom_sequence[0]
					...
					0 == t &&
						(console.warn(
							"Zoom factor must be greater than zero. Using 0.1"
						),
						(t = 0.1)),
					(this.options.scale_factor = t),
					this.goToId(
						this.current_id,
						!this._updateDrawTimeline(!0),
						!0
					);
			}
			...
			_positionGroups() {
				if (this.options.has_groups)
					for (
						...
						var r = Math.floor(
								n * (e + this.options.marker_padding)
							),
							a = !1;
			...
			_calculateMinimumTimeNavHeight() {
				return (
					this.timescale.getNumberOfRows() *
						this.options.marker_height_min +
					this._el.timeaxis_background.offsetHeight +
					this.options.marker_padding
				);
			}
			...
			goTo(t, e, i) {
				...
				this._resetMarkersActive(),
					t >= 0 &&
						...
						this._markers[t].setActive(!0),
					this.animator && this.animator.stop(),
					e
						? ((this._el.slider.className = "tl-timenav-slider"),
						  (this._el.slider.style.left =
								-this._markers[a].getLeft() +
								this.options.width / 2 +
								"px"))
						: i
			...
			_onMouseScroll(t) {
				...
				t || (t = window.event),
					...
					e &&
						...
						(t.returnValue = !1)),
					(i =
						parseInt(this._el.slider.style.left.replace("px", "")) +
						e) > n.left
						? (i = n.left)
						: i < n.right && (i = n.right),
					this.animate_css &&
		...
		class Ze {
			...
			getFormattedDate() {
				if (H(this.data.display_date).length > 0)
				...
				return (
					this.has.title ||
						(this.data.end_date &&
							(t =
								" &mdash; " +
								this.data.end_date.getDisplayDate(
									this.getLanguage()
								)),
						this.data.start_date &&
							(t =
								this.data.start_date.getDisplayDate(
									this.getLanguage()
								) + t)),
					t
				);
			...
			_initLayout() {
				if (
					...
					if (this.data.background.url) {
						...
						t &&
							((this._background_media = new t.cls(
								this.data.background,
								{
									background: 1,
								}
					...
					this.data.background.color &&
						...
						(this.has.background.color_value =
							this.data.background.color)),
				...
				this.data.media &&
					...
					this.has.media &&
						...
						(this.options.media_name =
							this.data.media.mediatype.name),
						(this.options.media_type =
							this.data.media.mediatype.type),
		...
		class Ge {
			...
			update(t) {
				...
				t.data.text &&
					t.data.text.headline &&
					(e.title = t.data.text.headline),
					this._update(e);
			}
		...
		class Ye {
			...
			changeBackground(t) {
				...
				t.color_value && "" != t.color_value
					...
					t.color_value
						? (this._el.background.style.backgroundColor =
								t.color_value)
						: (this._el.background.style.backgroundColor =
								"transparent"),
			...
			_updateDrawSlides() {
				for (
					var t = this.options.layout, e = 0;
					e < this._slides.length;
					e++
				)
			...
			_initLayout() {
				L(this._el.container, "tl-storyslider"),
					...
					w &&
						...
						this._message.updateMessage(
							this._("swipe_to_navigate")
						),
			...
			constructor(t, e, i) {
				...
				C(this.options, i),
					...
					this.options.is_embed &&
						L(this._el.container, "tl-timeline-embed"),
				...
				try {
					...
					(async function (t, e) {
						...
						try {
							...
							return (
								console.log(
									`Error loading language [${i}] ${t.statusText}`
								),
								null
							);
						}
			...
			_updateDisplay(t, e, i) {
				...
				i && (r = i),
					...
					c
						? ((a += " tl-mobile"),
						  (this.options.timenav_height =
								this._calculateTimeNavHeight(
									t,
									this.options
										.timenav_mobile_height_percentage
								)))
						: (this.options.timenav_height =
								this._calculateTimeNavHeight(t)),
					"portrait" == this.options.layout
					...
					(o =
						"top" == this.options.timenav_position
							...
							: Math.round(
									this.options.storyslider_height +
										1 +
										Math.ceil(this.options.timenav_height) /
											2 -
										this._el.menubar.offsetHeight / 2 -
										17.5
							  )),
					e
						? ((this._el.timenav.style.height =
						  ...
						  this.animator_storyslider &&
								this.animator_storyslider.stop(),
						  (this.animator_storyslider = ct(
								this._el.storyslider,
								{
									height:
					...
					"rtl" == this.options.language.direction &&
						(a += " tl-rtl"),
			...
			remove(t) {
				if (t >= 0 && t < this.config.events.length) {
					...
					delete this.config.event_dict[e[0].unique_id],
						this._storyslider.destroySlide(
							this.config.title ? t + 1 : t
						),
						this._storyslider._updateDrawSlides(),
